...
rays = (
    ...
    False,
    False,
)  # set first True, and oxyfull to geographic zenith to plot ray pointing to magnetic zentih
...
for f, ring, ray, p in zip(ccdflist, rings, rays, pstr):
    ...
    fiducial(img, xycrop[0], xycrop[1], outfn, ring, ray, p, oxyfull, wh0, lblring, ringmult, wh0)
