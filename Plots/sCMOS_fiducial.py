...
tlim = (datetime64("2011-03-01T10:06:06"), datetime64("2011-03-01T10:06:22"))
#%%
...
axlim = (
    ...
    magzenith_xy[1] + 275,
    magzenith_xy[1] - 275,
)  # optional pixel indices to show (xmin,xmax, ymax,ymin)
...
for i, T in enumerate(tlist):
    ...
    fiducial(
        img, xycrop[0], xycrop[1], outfn, rings, rays, T, tstr, magzenith_xy, wh0, ringmult, axlim
    )
