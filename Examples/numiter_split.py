...
Niter = (
    list(range(10)) + list(range(10, 20, 5)) + list(range(20, 50, 10)) + list(range(50, 100, 20))
)
#%%
Ncpu = (
    multiprocessing.cpu_count() // 2
)  # //2 makes one thread per CPU for 2 thread Intel Hyperthreading
...
def loadhist(nit):
    ...
    cmd = [
        "../FigureMaker.py",
        str((rdir / outpat.format(nit)) / ini.name),
        "-m",
        "fwd",
        "optim",
        "--load",
